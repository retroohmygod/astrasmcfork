...
void PreStitchedTextureMap::loadUVs()
{
	...
	if(iconType != Icon::TYPE_TERRAIN)
	{
		...
		ADD_ICON(1,		16,	L"chestplateEmerald")
		...
		ADD_ICON(2,     16,  L"leggingsEmerald")
		...
		ADD_ICON(6,		16,	L"pickaxeEmerald")
		...
		ADD_ICON(7,		3,	L"hatchetDiamond")
					ADD_ICON(7,		16,	L"hatchetEmerald")
