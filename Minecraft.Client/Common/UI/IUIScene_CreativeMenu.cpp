...
//		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::WOOD_SLAB)
	...
	DEF(eCreativeInventory_ToolsArmourWeapons)
		...
		ITEM(Item::helmet_emerald_Id)
		ITEM(Item::chestplate_emerald_Id)
		ITEM(Item::leggings_emerald_Id)
		ITEM(Item::boots_emerald_Id)
		ITEM(Item::sword_emerald_Id)
		ITEM(Item::shovel_emerald_Id)
		ITEM(Item::pickAxe_emerald_Id)
		ITEM(Item::hatchet_emerald_Id)
		ITEM(Item::hoe_emerald_Id)
