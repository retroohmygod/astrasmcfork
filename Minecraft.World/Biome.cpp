...
void Biome::staticCtor()
{
	...
	Biome::cherryBlossom = (new CherryBiome(23))->setColor(0xFCACEC)->setName(L"Cherry Blossom")->setLeafColor(0xFCACEC)->setTemperatureAndDownfall(0.8f, 0.4f)->setLeafFoliageWaterSkyColor(eMinecraftColour_Grass_Plains, eMinecraftColour_Foliage_CherryBlossom, eMinecraftColour_Water_Plains,eMinecraftColour_Sky_Plains);
